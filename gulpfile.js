...
var options = new function() {
  ...
  this.JS_SRC = ['app/libs/js/**/*.js', 'app/js/app.js', 'app/js/**/*.js','app/profiles/dev/*.js'],      // 0 index must be vendor libs for convention sake
  ...
  this.DIST_SRC = 'app/dest', // specific to spring-starter-project. change to suit your project needs.
...
gulp.task('clean', function() {
  return gulp.src([options.DIST_SRC + '/*'].concat('!'+options.DIST_SRC + '/swagger/')
